...
Подробные таблицы прав для каждого типа объекта — в `plugins/unica/skills/role-compile/dsl-reference.md`.
...
DSL принимает русские имена типов и прав, транслируя их в английские. Полные таблицы соответствий — в `plugins/unica/skills/role-compile/dsl-reference.md`.
